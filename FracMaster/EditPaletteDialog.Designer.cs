namespace FracMaster
{
  partial class EditPaletteDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.numericColorCount = new System.Windows.Forms.NumericUpDown();
      this.labelColorCount = new System.Windows.Forms.Label();
      ...
      ((System.ComponentModel.ISupportInitialize)(this.numericColorCount)).BeginInit();
      ...
      this.splitContainer1.Panel1.Controls.Add(this.numericColorCount);
      this.splitContainer1.Panel1.Controls.Add(this.labelColorCount);
      ...
      // numericColorCount
      // 
      this.numericColorCount.Font = new System.Drawing.Font("Microsoft Sans Serif", 14.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
      this.numericColorCount.Location = new System.Drawing.Point(154, 11);
      this.numericColorCount.Maximum = new decimal(new int[] {
            255,
            0,
            0,
            0});
      this.numericColorCount.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
      this.numericColorCount.Name = "numericColorCount";
      this.numericColorCount.Size = new System.Drawing.Size(120, 29);
      this.numericColorCount.TabIndex = 2;
      this.numericColorCount.Value = new decimal(new int[] {
            5,
            0,
            0,
            0});
      this.numericColorCount.ValueChanged += new System.EventHandler(this.numericColorCount_ValueChanged);
      // 
      // labelColorCount
      // 
      this.labelColorCount.AutoSize = true;
      this.labelColorCount.Font = new System.Drawing.Font("Microsoft Sans Serif", 14.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
      this.labelColorCount.Location = new System.Drawing.Point(26, 13);
      this.labelColorCount.Name = "labelColorCount";
      this.labelColorCount.Size = new System.Drawing.Size(122, 24);
      this.labelColorCount.TabIndex = 1;
      this.labelColorCount.Text = "V‰rien m‰‰r‰";
      // 
      // panel1
      // 
      ...
      ((System.ComponentModel.ISupportInitialize)(this.numericColorCount)).EndInit();
    ...
    private System.Windows.Forms.NumericUpDown numericColorCount;
    private System.Windows.Forms.Label labelColorCount;
  }
}